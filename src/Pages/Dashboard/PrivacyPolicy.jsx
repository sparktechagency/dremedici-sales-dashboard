      ...
      <div className=" p-6 rounded-lg shadow-sm mb-6">
        ...
        <ul className="list-disc pl-5">
          ...
          <li>
            ...
            or application, such as browsing patterns, clicks, and time spent on
            pages.
          </li>
          <li>
        ...
        <ul className="list-disc pl-5">
          ...
          <li>
            To process transactions and manage your subscriptions or purchases.
          </li>
          <li>
        ...
        <ul className="list-disc pl-5">
          <li>
            ...
            and service providers who assist us in operating our website or app,
            processing payments, or providing other services.
          </li>
          <li>
            Legal Requirements: We may disclose information if required by law,
            such as complying with a subpoena, legal process, or government
            request.
          </li>
        </ul>
